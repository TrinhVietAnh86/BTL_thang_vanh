...
<link rel="stylesheet" href="/BTL_thang_vanh/public/css/acc/edit_profile.css">
...
<form action="/BTL_thang_vanh/public/adminuser.php?controller=acc&action=deleteAccount" method="POST" onsubmit="return confirm('Bạn có chắc muốn xóa tài khoản? Hành động này không thể hoàn tác!');">
    <input type="submit" value="Xóa tài khoản" style="background-color: red; color: white; margin-top: 10px;" />
</form>

<form action="/BTL_thang_vanh/public/adminuser.php?controller=acc&action=logout" method="POST">
    <input type="submit" value="Đăng xuất" style="margin-top: 10px;" />
</form>
